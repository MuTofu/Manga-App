...
class HomeDummyAdapter(private val dataset: ArrayList<HomeDummyData>, private val myListener : RecyclerViewEvent) : RecyclerView.Adapter<HomeDummyAdapter.ViewHolder>() {
