...
class HomeNewUploadAdapter(private val listener : RecycleEvent) : RecyclerView.Adapter<HomeNewUploadAdapter.HomeViewHolder>() {
    ...
    inner class HomeViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
        ...
        override fun onClick(v: View?) {
            ...
            if (position != RecyclerView.NO_POSITION) {
                listener.onItemOngoingClick(position)
            }
        }
    ...
    interface RecycleEvent{
        fun onItemOngoingClick(position: Int)
    }
}